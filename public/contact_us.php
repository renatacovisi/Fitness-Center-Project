    ...
    <section class="jumbotron jumbotron-fluid rounded contact_us text-white">
      ...
      <form>
        <div class="form-group">
          <label class="font-weight-bold mt-2" for="FormControlInput">Name</label>
          <input type="text" class="form-control" id="FormNameInput" placeholder="Name">
          <label class="font-weight-bold mt-3" for="FormInput">E-mail</label>
          <input type="email" class="form-control" id="FormEmailInput" placeholder="your@name.com">
          <label class="font-weight-bold mt-3" for="FormInput">Phone Number</label>
          ...
          <button type="submit" class="btn btn-dark mt-3 float-right" >Submit</button>
          <div class="clearfix">
          </div>
        </div>
      </form>
