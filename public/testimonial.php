        ...
        <main class="mr-3 ml-3">
            ...
            <section>
                <div class="d-flex my-2">
                    <img src="../app/images/side_plank.svg" alt="class icon" class="backgroundColorYellow rounded testimonialIconSizeClasses">
                ...
                <div class="d-flex my-2">
                    <img src="../app/images/one_leg_up.svg" alt="class icon" class="backgroundColorYellow rounded testimonialIconSizeClasses">
                    <div class="card fColorSilver border-warning backgroundColor testimonialCardsSize">
                        <div class="card-body">
                ...
                <div class="d-flex my-2">
                    <img src="../app/images/cobra.svg" alt="class icon" class="backgroundColorYellow rounded testimonialIconSizeClasses">
                    <div class="card fColorSilver border-warning backgroundColor testimonialCardsSize">
                        <div class="card-body">
                ...
                <div class="d-flex my-2">
                    <img src="../app/images/seated_heart.svg" alt="class icon" class="backgroundColorYellow rounded testimonialIconSizeClasses">
                    <div class="card fColorSilver border-warning backgroundColor testimonialCardsSize">
                        <div class="card-body">
