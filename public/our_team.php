...
<section class="jumbotron jumbotron-fluid rounded our_team text-white">
  <div class="container">
    ...
    <button type="button" class="fColorIndigo btn btn-light m-1 ml-3 buttonSize">Join us</button>
  </div>
</section>
  ...
  <div class="row">
    <div class="col-6 col-md-4">
      <div class="card m-1 backgroundColorYellow fColorIndigo">
        <img class="card-img-top" src="../app/images/our_team_audrey.jpg" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">Audrey O'Connell</h5>
          <p class="card-text cardHeightOurTeamP1"> Audrey completed her 200hrs YTT in Hatha yoga and has been mentored
      ...
      <div class="col-6 col-md-4">
        <div class="card m-1 backgroundColorYellow fColorIndigo">
          <img class="card-img-top" src="../app/images/our_team_nance.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Nance McGowen</h5>
            <p class="card-text cardHeightOurTeamP1">Nance has experience in many styles including Children's yoga, Restorative,
        ...
        <div class="col-6 col-md-4">
          <div class="card m-1 backgroundColorYellow fColorIndigo">
            <img class="card-img-top" src="../app/images/our_team_zoe.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Zoe Burke</h5>
              <p class="card-text cardHeightOurTeamP1">Hailing from Australia, Zoe found Yoga and quickly fell in love. She moved
          ...
          <div class="col-6 col-md-4">
            <div class="card m-1 backgroundColorYellow fColorIndigo">
              <img class="card-img-top" src="../app/images/our_team_patrick.jpg" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title">Patrick Prince</h5>
                <p class="card-text cardHeightOurTeamP1">Patrick is a yoga and breath-work teacher. He took his teacher training in Goa,
            ...
            <div class="col-6 col-md-4">
              <div class="card m-1 backgroundColorYellow fColorIndigo">
                <img class="card-img-top" src="../app/images/our_team_paul.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5 class="card-title">Paul O'Brien</h5>
                  <p class="card-text cardHeightOurTeamP1">Paul spent his youth training in London. He began to train in India in 2004 where
              ...
              <div class="col-6 col-md-4">
                <div class="card m-1 backgroundColorYellow fColorIndigo">
                  <img class="card-img-top" src="../app/images/our_team_julie.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Julie</h5>
                    <p class="card-text cardHeightOurTeamP1">Julie originally qualified in Sports Therapy, Rehab and PT.
                      She completed her 250hrs YT Trainingwith The Yoga Rooms in Dublin.</p>
