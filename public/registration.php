...
<body class="backgroundColor">
  ...
  <div class="card-deck">
    <div class="row">
      ...
      <div class="card-body text-center">
        ...
        <label class="inline" for="planType"><p class="font-weight-bold">Tree</p></label>
        ...
        <p class="card-text">Slow Vinyasa</p>
        <p class="card-text">Power Vinyasa</p>
        <p class="card-text">Yin</p>
        <p class="card-text">Hatha</p>
      </div>
    </div>
  </div>
    ...
    <div class="card mt-1 backgroundColorYellow fColorIndigo">
      <div class="card-body text-center">
        ...
        <label class="inline" for="planType"><p class="font-weight-bold">Lotus</p></label>
      ...
      <div class="col-6 col-md-4 d-flex align-items-stretch">
        <div class="card mt-1 backgroundColorYellow fColorIndigo">
          <div class="card-body text-center">
            ...
            <label class="inline" for="planType"><p class="font-weight-bold">Butterfly</p></label>
  ...
  <form action="registration.php" method="post">
    <div class="col-md-9">
      <label class="font-weight-bold mt-1" for="FormNameInput">Name</label>
      <input type="text" class="form-control" id="FormNameInput" placeholder="">
      <label class="font-weight-bold mt-3" for="FormSurnameInput">Surname</label>
      <input type="text" class="form-control" id="FormSurnameInput" placeholder="">
      <label class="font-weight-bold mt-3" for="FormPpsInput">PPS Number</label>
      <input type="text" class="form-control" id="FormPpsInput" placeholder="">
